export const IconArrowMenuBurger = ({ classNameArrow, classNameSvg, fill, colorFirst, colorSecond }) => (
  <svg
    className={classNameArrow ? classNameArrow : 'arrow'}
    width='14'
    height='8'
    viewBox='0 0 14 8'
    fill='none'
  ...
  >
    <path
      className={classNameSvg ? classNameSvg : ''}
      fillRule='evenodd'
      clipRule='evenodd'
